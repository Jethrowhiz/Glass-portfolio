        ...
        <div className="glass rounded-2xl px-6 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a 
              ...
              className="px-5 py-2 rounded-lg bg-white/5 border border-white/10 text-white text-sm font-medium hover:bg-white/10 hover:border-cyan-500/50 transition-all hover:text-cyan-400"
            >
              Hire Me
            </a>
          </div>
